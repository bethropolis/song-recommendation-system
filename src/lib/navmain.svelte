...
<button
  class="p-2 hover:bg-gray-100 dark:hover:bg-gray-600 md:hidden rounded-full"
...
>
  ...
  <div class="flex right items-center">
    ...
    <div class="flex">
      <a href="https://github.com/bethropolis/song-recommendation-system/" target="_blank" class="mx-2" title="github repo">
        <svg
          class="h-6 w-6 text-gray-500 dark:text-gray-300"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
