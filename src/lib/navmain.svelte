...
<nav>
  ...
  <button class="mx-2" on:click={() => toggleDarkClass()} title="toggle dark mode">
    <svg
  ...
  <div class="flex">
    <a href="http://github.com/bethropolis/" class="mx-2" title="github repo">
      <svg
...
<style>
  nav {
    @apply w-full flex justify-end p-3;
  }
</style>
